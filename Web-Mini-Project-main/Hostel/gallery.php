...
<div class="container-all">
	<div class="container">
	<img class="img1" src="img/male dorm.jpg" alt="">
	<span class="title">Male dorm</span>
	<span class="text"> Get crazy with your male friends. <span>
</div>

<div class="container">
	<img class="img1" src="img/1.jpg" alt="" style="float:right">
...
<div class="container">
	<img class="img1" src="img/2.jpg" alt="" style="float:right">
	<span class="title">Exterior 1</span>
	<span class="text">Be prepared to experience in Bengaluru like a 
...
<div class="container">
	...
	<span class="text">A  themed rooftop, being bored is not an option here. <span>
</div>

<div class="container">
	<img class="img1" src="img/4.jpg" alt="">
	<span class="title">Corridor/alley</span>
	<span class="text"> themed corridors. <span>
</div>
...
<div class="container">
	<img class="img1" src="img/6.jpg" alt="">
...
<div class="container">
	<img class="img1" src="img/10.png" alt="">
